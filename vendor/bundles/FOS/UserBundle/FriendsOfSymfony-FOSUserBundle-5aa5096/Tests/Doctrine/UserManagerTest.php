...
class UserManagerTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		if (!interface_exists('Doctrine\Common\Persistence\ObjectManager')) {
			$this
					->markTestSkipped(
							'Doctrine Common has to be installed for this test to run.');
		}
		...
		$this->repository = $this
				->getMock('Doctrine\Common\Persistence\ObjectRepository');
		...
		$this->userManager = new UserManager($ef, $c, $c, $this->om,
				self::USER_CLASS);
	}
