...
class LoggerLoggingEvent {
	 ...
	 */
	public function __construct($fqcn, $logger, LoggerLevel $level, $message,
		...
		if ($this->locationInfo === null) {
			...
			while ($hop !== null) {
				if (isset($hop['class'])) {
					...
					if (!empty($className)
							and ($className == 'logger'
									or strtolower(get_parent_class($className))
											== 'logger')) {
			...
			$locationInfo['class'] = isset($prevHop['class']) ? $prevHop['class']
					: 'main';
	...
	public function getRenderedMessage() {
		if ($this->renderedMessage === null and $this->message !== null) {
			if (is_string($this->message)) {
				...
				$this->renderedMessage = $rendererMap
						->findAndRender($this->message);
			}
		}
	...
	public function __sleep() {
		return array('fqcn', 'categoryName', 'level', 'ndc',
				'ndcLookupRequired', 'message', 'renderedMessage',
				'threadName', 'timeStamp', 'locationInfo',);
	}
