...
class LoggerConfiguratorTest extends PHPUnit_Framework_TestCase {
	...
	public function testAppenderConfigNotArray() {
		$hierachyMock = $this
				->getMock('LoggerHierarchy', array(), array(), '', false);
	...
	public function testNotExistingAppenderClassSet() {
		Logger::configure(
				PHPUNIT_CONFIG_DIR . '/appenders/config_not_existing_class.xml');
	}
	...
	public function testNoAppenderLayoutClassSet() {
		Logger::configure(
				PHPUNIT_CONFIG_DIR . '/appenders/config_no_layout_class.xml');
	}
	...
	public function testNoRenderingClassSet() {
		Logger::configure(
				PHPUNIT_CONFIG_DIR . '/renderers/config_no_rendering_class.xml');
	}
	...
	public function testNoRenderedClassSet() {
		Logger::configure(
				PHPUNIT_CONFIG_DIR . '/renderers/config_no_rendered_class.xml');
	}
	...
	public function testInvalidLoggerAddivity() {
		Logger::configure(
				PHPUNIT_CONFIG_DIR . '/loggers/config_invalid_additivity.xml');
	}
	...
	public function testAppenderThreshold() {
		...
		$actual = Logger::getRootLogger()->getAppender('default')
				->getThreshold();
