...
class LoggerLayoutHtmlTest extends PHPUnit_Framework_TestCase {
	...
	public function testErrorLayout() {
		$event = new LoggerLoggingEvent("LoggerLayoutHtmlTest",
		...
		$e = PHP_EOL . "<tr>" . PHP_EOL . "<td>"
				. round(1000 * $event->getRelativeTime()) . "</td>" . PHP_EOL
				. "<td title=\"" . $event->getThreadName() . " thread\">"
				. $event->getThreadName() . "</td>" . PHP_EOL
				. "<td title=\"Level\">ERROR</td>" . PHP_EOL
				. "<td title=\"TEST category\">TEST</td>" . PHP_EOL
				. "<td title=\"Message\">testmessage</td>" . PHP_EOL . "</tr>"
				. PHP_EOL;
	...
	public function testWarnLayout() {
		...
		$e = PHP_EOL . "<tr>" . PHP_EOL . "<td>"
				...
				. PHP_EOL . "<td title=\"TEST category\">TEST</td>" . PHP_EOL
				. "<td title=\"Message\">testmessage</td>" . PHP_EOL . "</tr>"
				. PHP_EOL;
